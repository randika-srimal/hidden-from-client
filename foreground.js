...
async function start() {
    ...
    const commentBtn = await waitForElm('#fullscreen-modal-container > div > main > div > div.task-form-page__main > div.task-form-page__content > div.activity-form.is-field-initially-focused._form_h8tMg.js-organization-project-tasks-task-2-route-activity-form > form > div.activity-form__actions-wrapper > div.form-actions.form__actions.activity-form__actions > button');
